...
static const DBusGMethodInfo dbus_glib_device_methods[] = {
  { (GCallback) dbus_device_connect, dbus_glib_marshal_device_BOOLEAN__POINTER, 0 },
  { (GCallback) dbus_device_disconnect, dbus_glib_marshal_device_BOOLEAN__POINTER, 37 },
  { (GCallback) dbus_device_reqmdsattr, dbus_glib_marshal_device_BOOLEAN__POINTER, 77 },
  { (GCallback) dbus_device_getconfig, dbus_glib_marshal_device_BOOLEAN__POINTER_POINTER, 130 },
  { (GCallback) dbus_device_reqactivationscanner, dbus_glib_marshal_device_BOOLEAN__INT_POINTER, 188 },
  { (GCallback) dbus_device_reqdeactivationscanner, dbus_glib_marshal_device_BOOLEAN__INT_POINTER, 253 },
  { (GCallback) dbus_device_reqmdsattr, dbus_glib_marshal_device_BOOLEAN__POINTER, 320 },
  { (GCallback) dbus_device_releaseassoc, dbus_glib_marshal_device_BOOLEAN__POINTER, 384 },
  { (GCallback) dbus_device_abortassoc, dbus_glib_marshal_device_BOOLEAN__POINTER, 432 },
  { (GCallback) dbus_device_get_pmstore, dbus_glib_marshal_device_BOOLEAN__INT_POINTER_POINTER, 478 },
  { (GCallback) dbus_device_get_segminfo, dbus_glib_marshal_device_BOOLEAN__INT_POINTER_POINTER, 552 },
  { (GCallback) dbus_device_get_segmdata, dbus_glib_marshal_device_BOOLEAN__INT_INT_POINTER_POINTER, 630 },
  { (GCallback) dbus_device_clearsegmdata, dbus_glib_marshal_device_BOOLEAN__INT_INT_POINTER_POINTER, 733 },
  { (GCallback) dbus_device_clearallsegmdata, dbus_glib_marshal_device_BOOLEAN__INT_POINTER_POINTER, 834 },
  { (GCallback) dbus_device_set_time, dbus_glib_marshal_device_BOOLEAN__UINT64_POINTER, 914 },
};
