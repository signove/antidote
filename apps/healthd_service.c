 ...
 * @param list a pointer to data list.
 */
static void segment_data_received(Context *ctx, int handle, int instnumber, DataList *list)
{
 ...
 */
static void device_associated(Context *ctx, DataList *list)
{
 ...
 */
static int device_connected(Context *ctx, const char *low_addr)
{
 ...
 * @param low_addr low-level transport address
 */
static int device_disconnected(Context *ctx, const char *low_addr)
{
 ...
 */
static void device_disassociated(Context *ctx)
{
